...
const DashSidebar = () => {
    ...
    return (
        <div className="flex bg-indigo-900">
            <div className={` ${open ? "w-1/6" : "w-32"} bg-indigo-900 h-screen p-5  pt-8 relative duration-300`}>
                <Icon
                ...
                <div className="flex gap-x-2 items-center">
                    ...
                    />
                    <h1
                        className={`text-white origin-left font-medium text-4xl duration-200 ${!open && "scale-0 hidden"
                            }`}
                    >
