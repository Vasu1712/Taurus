...
const SignupComponent = () => {
    ...
    return (
        <div className='w-full h-full flex flex-col items-center bg-app-blue text-white overflow-auto'>
            ...
            <div className='inputRegion w-1/3 py-10 flex items-center justify-center flex-col'>
                {alertMessage && (
                    <div
                        ...
                        <div className='flex'>
                            <div className='py-1'>
                                <svg
                                    className={`fill-current h-6 w-6 text-${alertType === 'success' ? 'green' : 'red'
                                        }-500 mr-4`}
                ...
                <div className=' w-full flex items-center justify-center mb-5'>
                    <button
                        className='flex items-center justify-center rounded-full font-semibold bg-gradient-to-r from-purple-700 to-purple-900 p-3 px-10 mt-6'
                        onClick={(e) => {
                            e.preventDefault();
                            signUp();
                        }}>
